 ...
 * @author Italo
 */
public class ServletInserirProdutoGerenciamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            produto.setCategoria_id(Integer.parseInt(categoria_id));
            produto.setEstoque(Integer.parseInt(estoque));
            produto.setPreco(Double.parseDouble(preco));
            produto.setImg("img/produtos/" + img);
            ...
            request.getRequestDispatcher("buscarprodgen.id").forward(request, response);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletInserirProdutoGerenciamento.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
