                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="address-nav" data-toggle="pill" href="#address-tab" role="tab"><i class="fa fa-map-marker-alt"></i>Endereços</a> 
                    ...
                    <div class="col-md-9">
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="account-tab" role="tabpanel" aria-labelledby="account-nav">
                                ...
                                <p class="form-tip">Todos os campos marcados com * são obrigatórios.</p>  
                                <br>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" id="estado" name="estado">
                                                ...
                                                <option value="AP" ${usuario.getEndereco().getEstado() == "AP" ? "selected" : ""}>Amapá</option>
                                                ...
                                                <option value="CE" ${usuario.getEndereco().getEstado() == "CE" ? "selected" : ""}>Ceará</option>
                                                <option value="DF" ${usuario.getEndereco().getEstado() == "DF" ? "selected" : ""}>Distrito Federal</option>
                                                <option value="ES" ${usuario.getEndereco().getEstado() == "ES" ? "selected" : ""}>Espírito Santo</option>
                                                <option value="GO" ${usuario.getEndereco().getEstado() == "GO" ? "selected" : ""}>Goiás</option>
                                                <option value="MA" ${usuario.getEndereco().getEstado() == "MA" ? "selected" : ""}>Maranhão</option>
                                                ...
                                                <option value="PA" ${usuario.getEndereco().getEstado() == "PA" ? "selected" : ""}>Pará</option>
                                                <option value="PB" ${usuario.getEndereco().getEstado() == "PB" ? "selected" : ""}>Paraíba</option>
                                                <option value="PR" ${usuario.getEndereco().getEstado() == "PR" ? "selected" : ""}>Paraná</option>
                                                <option value="PE" ${usuario.getEndereco().getEstado() == "PE" ? "selected" : ""}>Pernambuco</option>
                                                <option value="PI" ${usuario.getEndereco().getEstado() == "PI" ? "selected" : ""}>Piauí</option>
                                                ...
                                                <option value="RO" ${usuario.getEndereco().getEstado() == "RO" ? "selected" : ""}>Rondônia</option>
                                                ...
                                                <option value="SP" ${usuario.getEndereco().getEstado() == "SP" ? "selected" : ""}>São Paulo</option>
