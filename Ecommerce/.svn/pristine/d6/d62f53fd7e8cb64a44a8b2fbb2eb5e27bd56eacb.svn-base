...
public class ServletAlterarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (dao.BuscarPorId(usuario.getId(), false) != null) {
            ...
            request.setAttribute("msg", "Dados Pessoais alterados com sucesso!");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletAlterarUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
