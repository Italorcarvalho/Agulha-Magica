...
public class ServletRemoverDoCarrinho extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Carrinho carr = car.BuscarPorId(Integer.parseInt(id));

            if (carr != null) {
                car.Excluir(carr.getId());
                carrinho = car.BuscarPorUsuarioId(usuario.getId());
            }          
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletRemoverDoCarrinho.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
