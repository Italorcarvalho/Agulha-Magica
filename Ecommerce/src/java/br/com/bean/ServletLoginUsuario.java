    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (usuario == null) {
                ...
                usuario.setEndereco(dao2.BuscarPorUsuarioId(usuario.getId()));

                CarrinhoDAO dao3 = new CarrinhoDAO();
                ArrayList<Carrinho> carrinho = dao3.BuscarPorUsuarioId(usuario.getId());

                ListaDesejoDAO dao4 = new ListaDesejoDAO();
                ArrayList<ListaDesejo> listadesejos = dao4.BuscarPorUsuarioId(usuario.getId());
